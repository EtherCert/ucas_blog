            ...
            <form action="{{route('admin.posts.update', $post->id)}}" class="form" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>العنوان</label>
                            <input required type="text" name="title" value="{{old('title', $post->title)}}" class="form-control @error('title') is-invalid @enderror" />
                            @error('title')
                        ...
                        <div class="col-lg-6 mt-5">
                            ...
                            <div class="custom-file">
                                <input required name="post_img" type="file" class="custom-file-input @error('post_img') is-invalid @enderror" id="customFileLang"
                                    lang="ar">
